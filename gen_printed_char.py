...
class Font2Image(object):
    ...
    def do(self, font_path, char, rotate=0):
        ...
        draw = ImageDraw.Draw(img)
        font = ImageFont.truetype(font_path, int(self.width * (random.random()*0.2+0.7)),)
        # 白色字体
...
##############################syt###############################
    ...
    BGGen = DataGenerater(font_path=font_path, char_size=(100, 100))
